...
export class MealApp extends Component {
  ...
  render() {
    return <div className='container'>{this.props.meals.length && <MealList meals={this.props.meals} getCityName={this.getCityName} getAvgRate={this.getAvgRate}></MealList>}</div>;
  }
}
